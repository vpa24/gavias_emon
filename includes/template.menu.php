...
function gavias_emon_preprocess_menu__main(&$variables) {
    preprocess_menu($variables);
}

function gavias_emon_preprocess_menu__enterprise_main(&$variables) {
    preprocess_menu($variables);
}

function preprocess_menu(&$variables) {
    ...
    foreach ($variables['items'] as &$item) {      
      ...
      if (count($menu_link_attributes)) {
         ...
         $item['attributes']['gva_class'] = (isset($attributes['gva_class']) && $attributes['gva_class']) ? trim($attributes['gva_class']): $language;
